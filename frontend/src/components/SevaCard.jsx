  ...
  return (
    <div className="border rounded-xl shadow-lg p-4 flex flex-col items-center hover:shadow-xl transition-shadow">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${seva.media || "/placeholder-image.jpg"})`,
        }}
      />
      ...
      <div className="flex flex-col gap-2 w-full">
        <button
          onClick={onAddToCart}
          className="w-full border py-2 rounded hover:bg-gray-100 transition-colors"
        >
          Add to Cart
        </button>
        ...
        <button
          ...
          className="w-full border py-2 rounded hover:bg-gray-100 transition-colors"
          disabled={!isInCart} // optional: disable if not in cart
        >
          Remove from Cart
        </button>
      </div>
